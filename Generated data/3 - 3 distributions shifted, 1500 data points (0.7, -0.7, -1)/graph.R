...
# Graphique
combined_data <- rbind(transform(data1[data1$status==1,], dataset = "Dataset 1"),
                       transform(data2[data2$status==1,], dataset = "Dataset 2"),
                       transform(data3[data3$status==1,], dataset = "Dataset 3"))
