...
betas <- c(2, -1, 0.5) # Example betas for X1, X2, and X3 , 0.032, 1.5, -0.017
...
X1 <- rnorm(N, mean=0, sd=1.7)       # Normal distribution
X2 <- rbinom(N, size=1, prob=0.4)  # Binomial distribution
X3 <- runif(N, min=-0.2, max=0.6)      # Uniform distribution
